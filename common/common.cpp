...
struct llama_model_params common_model_params_to_llama(common_params & params) {
    ...
    mparams.vulkan_managed_weights    = params.vk_managed_weights;
    mparams.vulkan_managed_eager      = params.vk_managed_eager;
    mparams.vulkan_managed_cache_size = params.vk_managed_cache_size;
